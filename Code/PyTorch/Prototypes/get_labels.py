...
label_name = "803_Full_Annotation_List_Lineage"
...
list_csv = pd.read_csv("/pvol/Annotationsets/Full_Annotationsets/20231002_803_Full_Annotation_List.csv", dtype=str, usecols=['label.name', 'label.translated.name', 'label.translated.lineage_names'])
...
pivot_df = list_csv.pivot_table(index = ['label.translated.lineage_names'], aggfunc ='size')
...
pivot_df.to_csv(f'//pvol/Annotationsets/Distribution/{csv_name}.csv')
